...
1. [Purpose & Integration](#purpose--integration)
2. [Quick Compliance Check](#quick-compliance-check)
3. [Domain Validation Checklists](#domain-validation-checklists)
4. [Voice & Tone Standards](#voice--tone-standards)
