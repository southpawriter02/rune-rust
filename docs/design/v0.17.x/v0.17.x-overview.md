...
#### Deliverables
- [ ] `Background` enum with 6 values
- [ ] `BackgroundDefinition` entity
- [ ] `StartingSkillGrant` value object
- [ ] `StartingEquipmentGrant` value object
- [ ] `IBackgroundProvider` interface
- [ ] `BackgroundProvider` with JSON loading
- [ ] Configuration file: `backgrounds.json`
...
#### Deliverables
- [ ] `Archetype` enum with 4 values
- [ ] `ArchetypeDefinition` entity
- [ ] `ArchetypeResourceBonus` value object
