...
using DomainServices = RuneAndRust.Domain.Services;
...
public class ExaminationService : IExaminationService
{
    ...
    private readonly DomainServices.SkillCheckService _skillCheckService;
    ...
    public ExaminationService(
        ...
        DomainServices.SkillCheckService? skillCheckService = null,
        Random? random = null)
    {
        ...
        _skillCheckService = skillCheckService ?? new DomainServices.SkillCheckService();
