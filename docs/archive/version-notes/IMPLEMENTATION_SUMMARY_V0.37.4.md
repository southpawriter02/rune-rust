...
7. **RuneAndRust.Tests/SystemCommandsTests.cs** (~500 lines)
...
**Syntax:** `talk [to] [npc_name]`, `speak [npc]`
**Arguments:** NPC name (multi-word supported, "to" optional)
...
**Syntax:** `command [companion] [action] [target]`, `cmd [companion] [action]`
**Arguments:** Companion name, action/ability, target (optional)
...
**Total v0.37 Timeline: ~35-45 hours**
**Actual Implementation: 4 phases completed**
