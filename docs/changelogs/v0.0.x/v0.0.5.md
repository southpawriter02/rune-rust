# Changelog: v0.0.5 - The Spatial Core
...
- [Logging Matrix (v0.0.5)](#logging-matrix-v005)
- [Test Summary by Category](#test-summary-by-category)
- [Build Verification](#build-verification)
- [Directory Structure After v0.0.5](#directory-structure-after-v005)
- [Database Schema](#database-schema)
- [Commands Reference (Updated)](#commands-reference-updated)
- [Migration Instructions](#migration-instructions)
- [Next Steps (v0.1.0: Character Creation)](#next-steps-v010-character-creation)
