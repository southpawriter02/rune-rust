...
**File Path:** `RuneAndRust.Engine/CombatEngine.cs`, `CombatEngine_GaldrFlavorExtensions.cs`
**Version:** v0.38.12
...
- [Combat Resolution System](../../01-systems/combat-resolution.md) - Functional overview
- [Damage Calculation](../../01-systems/damage-calculation.md) - Damage formulas
- [Status Effects](../../01-systems/status-effects.md) - Status effect mechanics
- [Accuracy & Evasion](../../01-systems/accuracy-evasion.md) - Hit/miss calculations

### Related Services

- [DiceService](./dice-service.md) - Core dice mechanics
- [EnemyAI](./enemy-ai.md) - Enemy decision-making
- [FlankingService](./flanking-service.md) - Flanking calculations
- [CoverService](./cover-service.md) - Cover mechanics
