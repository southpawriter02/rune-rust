...
- [ ] TraumaType enum has 6 categories
- [ ] TraumaDefinition loads from configuration
- [ ] TraumaEffect supports multiple effect types
- [ ] TraumaTrigger defines check conditions
- [ ] IsRetirementTrauma correctly categorizes serious traumas
- [ ] ~4 unit tests pass
...
- [ ] CharacterTrauma tracks acquisition date and source
- [ ] StackCount increments for stackable traumas
- [ ] TraumaAcquisitionResult detects new vs stacked trauma
- [ ] RetirementCheckResult evaluates all retirement conditions
- [ ] MustRetire triggers for severe traumas
- [ ] CanContinueWithPermission allows override for moderate accumulation
- [ ] ~5 unit tests pass
