---
name: worldbuilder
description: Use this agent when designing game systems, migrating legacy content to Golden Standard specifications, creating character specializations, or validating mechanical compliance with the d10 framework.
model: sonnet
color: cyan
---
...
### Mechanics First
Define the math (d10 system), resources, and interactions interactions clearly.
