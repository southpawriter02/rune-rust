...
1. **`RuneAndRust.Engine/FuryService.cs`** (19KB)
...
2. **`RuneAndRust.Engine/BerserkrService.cs`** (13KB)
...
1. **`RuneAndRust.Tests/BerserkrSpecializationTests.cs`** (17KB)
...
**End of Implementation SummaryVersion**: v0.26.1
**Date**: 2025-11-15