...
- [x] Gold scaled by multiplier
- [x] Quality bonus shifts tier correctly
- [x] ~2 unit tests pass (28 tests implemented)
...
- [x] Container state persists after looting
- [x] Reset clears all container states
- [x] 13 unit tests pass (contract tests, exceeds ~2 estimate)
