...
**Purpose:** Generate dungeon graph with valid adjacencies

### Dice Pool System
**File:** `DiceService.cs`
**Mechanic:** Roll Xd6, count 5-6 as successes

### Initiative System
**File:** `CombatEngine.cs`
**Mechanic:** Roll FINESSE attribute, sort by successes
...
**Files:** `WorldStateChange.cs`, `DestructionService.cs`
**Purpose:** Record player modifications, apply on load
...
5. Document AbilityDatabase.cs (abilities registry)
6. Document EquipmentDatabase.cs (equipment registry)
7. Document EnemyFactory.cs (enemy registry)
8. Document BiomeLibrary.cs (biome definitions)

### Lower Priority (Phase 6-9)
9. Document all CoherentGlitch rules
10. Document QuestService.cs + DynamicQuestGenerator.cs
11. Document DialogueService.cs
12. Document MerchantService.cs + economy services
