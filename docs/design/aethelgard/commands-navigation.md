...
Type: UI
Description: Command specification defining 7 navigation commands (go, look, search, investigate, travel, enter, exit) with syntax, aliases, validation, Mermaid behavior flowcharts, C# service interfaces (INavigationCommandService), loot generation tables (5 tiers), secret discovery mechanics (6 categories), Z-axis navigation, and comprehensive TUI examples.
Priority: Must-Have
Status: In Design
Target Version: Alpha
Dependencies: Navigation System (SPEC-SYS-NAVIGATION), Spatial Layout, Map UI, Room Engine, Command Parser, WITS attribute, Loot System, Codex System
Implementation Difficulty: Hard
Balance Validated: No
Dependency Status: Awaiting Design
Document ID: SPEC-CMD-NAVIGATION
Domain: UI/UX, World/Exploration
Implementation Notes: MODERNIZED FORMAT. Defines 7 navigation commands with Mermaid flowcharts, C# interfaces (INavigationCommandService + 12 data records), loot generation (5 container tiers), secret categories (6 types), Z-axis navigation (6 vertical exit types). Has Phased Implementation (6 phases), Testing Requirements (5 categories, 20 tests), Changelog (v2.0). Missing: Voice Guidance. Companion to SPEC-SYS-NAVIGATION (system overview).
Last Design Review: December 14, 2025
...
| [parser](https://www.notion.so/parser-e77a048a24ab4fd8be1517bd41667887?pvs=21) | Command parsing and aliases |
