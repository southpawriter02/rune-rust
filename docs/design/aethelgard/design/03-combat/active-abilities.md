---
id: SPEC-COMBAT-ACTIVE-ABILITIES
title: "Active Abilities — System Specification"
version: 1.0
status: draft
...
related-files:
  - path: "docs/03-combat/combat-resolution.md"
    status: Reference
  - path: "docs/03-combat/defensive-reactions.md"
    status: Reference
  - path: "docs/03-combat/status-effects.md"
    status: Reference
  - path: "docs/.templates/ability.md"
    status: Template
  - path: "RuneAndRust.Engine/AbilityService.cs"
    status: Planned
---

# Active Abilities — System Specification
...
|---------|--------------|
| [Passive Abilities](passive-abilities.md) | Companion ability system (always-on effects) |
| [Combat Resolution](combat-resolution.md) | Ability execution in combat |
| [Defensive Reactions](defensive-reactions.md) | Reaction mechanics (Parry, Block, Evasion) |
| [Status Effects](status-effects.md) | Effects applied by abilities |
