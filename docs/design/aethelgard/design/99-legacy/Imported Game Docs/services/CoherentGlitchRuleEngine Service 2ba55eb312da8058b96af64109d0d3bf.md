...
**File Path:** `RuneAndRust.Engine/CoherentGlitch/CoherentGlitchRuleEngine.cs`**Version:** v0.12
...
- [PopulationPipeline](https://www.notion.so/population-pipeline.md) - Room population orchestration
- [BiomeLibrary](https://www.notion.so/biome-library.md) - Biome element definitions
