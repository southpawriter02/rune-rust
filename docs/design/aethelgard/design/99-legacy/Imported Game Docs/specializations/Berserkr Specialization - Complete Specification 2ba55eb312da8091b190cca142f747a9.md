...
1. **Route Berserkr abilities** through CombatEngine
2. **Implement Fury generation** from damage dealt/taken
3. **Add Fury bar** to CombatView

### Phase 3: Status Effects

1. **Define status effects** ([Vulnerable], [Bleeding], [Empowered])
2. **Implement death prevention** (Unstoppable Fury)
3. **Implement immunity system** (Fear, Stun)

### Phase 4: Polish

1. **Add rank-specific icons** (Bronze/Silver/Gold)
2. **Implement rank-up notifications**
3. **Add death prevention notification**
