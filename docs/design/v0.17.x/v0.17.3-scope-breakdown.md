...
**Unit Tests (~2):**
- [x] GetAllArchetypes returns 4 archetypes
- [x] GetArchetype returns correct definition
...
- [x] Archetype enum has 4 values
- [x] Each archetype has distinct resource bonuses
- [x] Warrior has +49 HP bonus
- [x] Skirmisher has +1 Movement bonus
- [x] Mystic has +20 AP bonus
- [x] Adept has +20% consumable effectiveness
- [x] Each archetype grants 3 starting abilities
- [x] Warrior starts with Strike, Defensive Stance, Warrior's Vigor
- [x] Mystic starts with Aether Dart, Focus Aether, Aetheric Attunement
- [x] Archetype determines available specializations
- [x] Warrior has 6 available specializations
- [x] Mystic has 2 available specializations
- [x] Archetype choice is permanent (cannot be changed)
- [x] Resource bonuses apply to derived stats
