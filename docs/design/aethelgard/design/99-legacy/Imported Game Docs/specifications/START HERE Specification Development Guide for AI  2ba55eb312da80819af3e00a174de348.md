...
| [**SPEC_BACKLOG.md**](https://www.notion.so/SPEC_BACKLOG.md) | Spec registry & backlog | See what specs exist & what's needed |
| [**TEMPLATE.md**](https://www.notion.so/TEMPLATE.md) | Master specification template | Copy this to create new specs |
| [**README.md**](https://www.notion.so/README.md) | Complete writing guide (2,050 lines) | Deep dive on governance, walkthroughs |
| [**SETTING_COMPLIANCE.md**](https://www.notion.so/SETTING_COMPLIANCE.md) | Aethelgard lore validation | Check during draft & review |
| [**Example Specs**](START%20HERE%20Specification%20Development%20Guide%20for%20AI%20%202ba55eb312da80819af3e00a174de348.md) | Reference implementations | Model your work on these |
...
- Read [**SPEC_BACKLOG.md**](https://www.notion.so/SPEC_BACKLOG.md) to see if this spec is already planned
...
**Use Walkthrough 1 from [README.md](http://readme.md/)**: [Analyzing an Existing System](https://www.notion.so/README.md#walkthrough-1-analyzing-an-existing-system)
...
**Use Walkthrough 2 from [README.md](http://readme.md/)**: [Planning a New Specification](https://www.notion.so/README.md#walkthrough-2-planning-a-new-specification)
...
5. **Check Setting Compliance**: Review [SETTING_COMPLIANCE.md](https://www.notion.so/SETTING_COMPLIANCE.md) for applicable domains
...
**Use Walkthrough 4 from [README.md](http://readme.md/)**: [Drafting the Specification](https://www.notion.so/README.md#walkthrough-4-drafting-the-specification)

**Process:**

1. **Copy [TEMPLATE.md](http://template.md/)** to `docs/00-specifications/{domain}/{system-name}-spec.md`
...
5. **Reference existing specs for patterns**:
    - [SPEC-COMBAT-001](https://www.notion.so/combat/combat-resolution-spec.md) - Combat mechanics with initiative
    - [SPEC-PROGRESSION-001](https://www.notion.so/progression/character-progression-spec.md) - Economy with formulas
    - [SPEC-ECONOMY-003](https://www.notion.so/economy/trauma-economy-spec.md) - State tracking with thresholds
...
1. **Completeness** (use checklist at bottom of [TEMPLATE.md](http://template.md/)):
...
**File**: [combat/combat-resolution-spec.md](https://www.notion.so/combat/combat-resolution-spec.md)**Lines**: ~600
...
**File**: [progression/character-progression-spec.md](https://www.notion.so/progression/character-progression-spec.md)**Lines**: ~650
...
**File**: [economy/trauma-economy-spec.md](https://www.notion.so/economy/trauma-economy-spec.md)**Lines**: ~650
...
- Read [SETTING_COMPLIANCE.md](https://www.notion.so/SETTING_COMPLIANCE.md) Quick Compliance Check
...
3. **Setting compliance questions**: Reference [SETTING_COMPLIANCE.md](https://www.notion.so/SETTING_COMPLIANCE.md) domain checklists
4. **Specification structure questions**: Check example specs for patterns

**Key resources**:

- **Complete writing guide**: [README.md](https://www.notion.so/README.md) (2,050 lines)
- **All walkthroughs**: [README.md - Walkthroughs section](https://www.notion.so/README.md#part-5-comprehensive-walkthroughs)
- **Setting fundamentals**: [SETTING_COMPLIANCE.md](https://www.notion.so/SETTING_COMPLIANCE.md)
- **Governance framework**: [README.md - Governance section](https://www.notion.so/README.md#specification-governance)
...
1. Copy [TEMPLATE.md](https://www.notion.so/TEMPLATE.md) to your new spec file
