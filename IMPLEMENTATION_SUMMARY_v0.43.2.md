...
**Interfaces**: `ISpriteService`
**Implementation**: `SpriteService`
...
**ViewModel**: `SpriteDemoViewModel`
**View**: `SpriteDemoView.axaml`
...
10. `RuneAndRust.DesktopUI/RuneAndRust.DesktopUI.csproj` - Added SkiaSharp packages
11. `RuneAndRust.DesktopUI/App.axaml.cs` - Registered SpriteService, added sprite loading
12. `RuneAndRust.DesktopUI/App.axaml` - Added SpriteDemoViewModel DataTemplate
13. `RuneAndRust.DesktopUI/ViewModels/MenuViewModel.cs` - Added SpriteDemoCommand, navigation
14. `RuneAndRust.DesktopUI/Views/MenuView.axaml` - Added "Sprite Demo" button
