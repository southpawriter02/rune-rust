...
- [x] GenerateLoot uses quality tier system
- [x] Monster type maps to correct drop class
- [x] Generated items have tier-appropriate stats
- [x] LootDrop tracks highest tier correctly
- [x] HasMythForged flag set when applicable
- [x] ~5 unit tests pass (47 tests added)
