...
- [Event System](https://www.notion.so/event-system.md) - Controller event patterns
- [Error Handling](https://www.notion.so/error-handling.md) - Exception patterns in controllers
- [Service Architecture](https://www.notion.so/service-architecture.md) - Engine service layer
- [Data Flow](https://www.notion.so/data-flow.md) - Data flow between systems
- [System Integration Map](https://www.notion.so/system-integration-map.md) - Engine-level integration