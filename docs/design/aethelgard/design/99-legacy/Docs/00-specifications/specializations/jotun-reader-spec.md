...
5. **Route Jötun-Reader abilities** through CombatEngine
6. **Implement Analyze Weakness** revelation system
7. **Implement Exploit Design Flaw** party-wide accuracy buff
8. **Implement The Unspoken Truth** psychological attack

### Phase 3: Capstone & Advanced
9. **Implement Architect of the Silence** with target restriction
10. **Add [Seized] status effect** with complete paralysis
11. **Implement passive auto-analysis** for machines

### Phase 4: Exploration Integration
12. **Implement Runic Linguistics** translation system
13. **Implement Structural Insight** environmental detection
14. **Implement Navigational Bypass** trap resistance
15. **Implement Calculated Triage** healing zone
