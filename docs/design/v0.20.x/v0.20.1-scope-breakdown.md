...
*This scope breakdown provides a structured approach to implementing the Skjaldmær specialization. Each sub-phase builds on the previous, allowing for incremental development and testing of the defensive tank archetype.*
