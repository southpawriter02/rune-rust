...
**File Path:** `RuneAndRust.Engine/EnemyAI.cs`**Version:** v0.42.1
...
- [Combat Resolution](https://www.notion.so/01-systems/combat-resolution.md) - Combat flow
- [Enemy Bestiary](https://www.notion.so/02-statistical-registry/enemies-registry.md) - Enemy stats

### Related Services

- [CombatEngine](https://www.notion.so/combat-engine.md) - Executes AI decisions
- [DiceService](https://www.notion.so/dice-service.md) - Random action selection
