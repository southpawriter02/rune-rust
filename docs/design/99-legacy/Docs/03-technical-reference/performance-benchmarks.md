...
- [Optimization Strategies](optimization-strategies.md) - Caching and optimization patterns
- [Service Architecture](service-architecture.md) - Service performance considerations
- [Data Flow](data-flow.md) - Pipeline timing
