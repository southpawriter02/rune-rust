...
1. **Route Skjaldmaer abilities** through CombatEngine
2. **Implement ability execution** for all 9 abilities
3. **Create ability selection dialog** in combat

### Phase 3: Reaction System

1. **Build reaction prompt framework**
2. **Implement Interposing Shield** trigger and prompt
3. **Implement Bastion of Sanity** trigger and prompt

### Phase 4: Polish

1. **Add rank-specific icons** (Bronze/Silver/Gold)
2. **Implement rank-up notifications**
3. **Add passive ability indicators**
4. **Implement aura visual effects**
