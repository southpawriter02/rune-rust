...
- [ ] StressThreshold enum has 6 values with correct stress ranges
- [ ] StressSource enum has 6 categories
- [ ] RestType enum has 4 types with documented formulas
- [ ] StressState correctly computes DefensePenalty as floor(Stress/20)
- [ ] StressState correctly flags HasSkillDisadvantage at 80+
- [ ] StressState correctly flags RequiresTraumaCheck at exactly 100
- [ ] ~4 unit tests pass
...
- [ ] StressCheckResult computes ReductionPercent from Successes
- [ ] StressApplicationResult detects ThresholdCrossed correctly
- [ ] StressRecoveryResult detects ThresholdDropped correctly
- [ ] ~3 unit tests pass
