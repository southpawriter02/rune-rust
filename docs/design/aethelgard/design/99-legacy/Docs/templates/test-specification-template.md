...
**Test Suite:** `[TestClassName]Tests.cs`
**System Under Test:** `[ClassName]`
**File Path:** `RuneAndRust.Tests/[TestFileName].cs`
**Coverage Target:** XX%
**Last Updated:** [Date]
...
#### Test 1: [MethodName]_[Scenario]_[ExpectedBehavior]
...
#### Test 2: [MethodName]_[Scenario]_[ExpectedBehavior]
