...
-- Expert (DC 18)
('Door', 'LockedDoor', 'Expert', NULL, 'Locked', 'A heavy iron door bearing the sigil of High Security Clearance (Level 7). The lock mechanism uses a combination of physical tumblers and runic verification. Age has corrupted the rune-lock—a skilled infiltrator might bypass the physical mechanism, or someone with Galdr knowledge could attempt to stabilize the runic component.', 1.0, '["Technical", "Lore", "Tactical"]'),
('Door', 'LockedDoor', 'Expert', NULL, 'Locked', 'This door is a masterwork of Jötun protection rites. The three-stage lock combines mechanical precision with binding wards. The ward runes have degraded over 800 years—observations suggest you could exploit this weakness with the right knowledge.', 1.0, '["Technical", "Lore", "Historical"]');
...
-- Detailed (DC 12)
('Door', 'BlastDoor', 'Detailed', NULL, 'Sealed', 'A massive blast door, thicker than a shield-wall. Emergency seals were activated—the door was closed during the Blight''s arrival. The control panel is dark but intact.', 1.0, '["Historical", "Technical"]'),
...
('Machinery', 'ControlPanel', 'Expert', NULL, 'Operational', 'This panel controlled automated defense systems. The weapon turrets it linked to are long destroyed, but the targeting eyes remain active. You could potentially realign them to serve as early warning watchers.', 1.0, '["Technical", "Tactical"]'),
...
('RecentActivity', 'ExpertSuccess', 18, NULL, 'You analyze the signs of recent activity.', 'Multiple entities passed through: at least three humanoids and one large creature. Timeline: less than a day ago. The humanoids were fleeing—the stride patterns show panic. The creature was hunting them.', 1.0, '["Intelligence", "Tracking"]'),
...
('Luminous Shelf Fungus', 'Fungus', 'Detailed', 'The_Roots', 1, 0, 'light-source potions', 'Massive shelf fungus, bioluminescent—a common sight in the lower levels. The glow is natural, produced by symbiotic spirits within. The fungus is edible but bitter. Alchemically useful for light-source potions.', 1.0, '["Bioluminescent", "Alchemy"]'),
...
('Lava Blossom', 'Flower', 'Expert', 'Muspelheim', 1, 1, 'supreme fire resistance, regeneration of burned tissue', 'Lava Blossom, Ignis rosa. This plant evolved in Muspelheim''s post-volcanic transformation, adapting to conditions that defy biological norms. Its petals contain heat-warding essences that can be extracted for supreme fire resistance potions. More remarkably, the pollen promotes regeneration of burned tissue at an accelerated rate. Harvesting requires approaching active lava flows during the brief window when the blossoms bloom. Risk: extreme. Reward: unparalleled.', 1.0, '["Fire", "Alchemy", "Extreme"]');
...
('Frost Lichen', 'Lichen', 'Detailed', 'Niflheim', 1, 0, 'cold resistance potions', 'Frost Lichen, adapted to freezing temperatures. It grows slowly, spreading across any frozen surface. The blue coloration comes from ice crystals integrated into its living weave. Alchemically useful for cold resistance potions.', 1.0, '["Ice", "Alchemy"]'),
('Frost Lichen', 'Lichen', 'Expert', 'Niflheim', 1, 0, 'cold resistance, frost Galdr, ice-stasis', 'Frost Lichen, Glacies lichenus. This organism exists in a state of partial suspended animation, its life-signs slowed to a crawl. It can survive the deepest cold. The lichen produces warming humours that prevent ice crystal formation in living tissue—invaluable for cold resistance potions and experimental ice-stasis. Harvest carefully; the lichen is brittle when frozen and will shatter if mishandled.', 1.0, '["Ice", "Alchemy", "Scientific"]');
