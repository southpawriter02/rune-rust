...
- [x] `config/stress-sources.json`

### JSON Schemas

- [x] `config/schemas/stress-sources.schema.json`

### Application DTOs

- [x] `src/Core/RuneAndRust.Application/DTOs/StressSourceDefinitionDto.cs`
- [x] `src/Core/RuneAndRust.Application/DTOs/StressRecoveryConfigDto.cs`
- [x] `src/Core/RuneAndRust.Application/DTOs/StressConfigurationDto.cs`

### Unit Tests

- [x] `tests/RuneAndRust.Infrastructure.IntegrationTests/Schemas/StressSourcesSchemaTests.cs`
...
- [x] Schema enforces kebab-case ID pattern
- [x] Configuration includes all 6 stress source categories
- [x] Configuration includes all 4 recovery rate formulas
- [x] Configuration includes trauma reset values (75/50)
- [x] DTOs deserialize correctly from JSON

### Quality Criteria

- [x] Build succeeds with 0 errors
- [x] Build succeeds with 0 warnings
- [x] All ~3 unit tests pass (19 actual)
- [x] XML documentation complete on all DTOs
