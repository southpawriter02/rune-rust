...
- [Service Architecture](https://www.notion.so/service-architecture.md) - Service design patterns
- [Data Flow](https://www.notion.so/data-flow.md) - Pipeline error handling
- [Event System](https://www.notion.so/event-system.md) - Event result types
- [Performance Benchmarks](https://www.notion.so/performance-benchmarks.md) - Error timing metrics