...
- [Combat Resolution System](https://www.notion.so/combat-resolution.md) - Turn order and combat flow
- [Damage Calculation System](https://www.notion.so/damage-calculation.md) - What happens after hit lands
- [Status Effects System](https://www.notion.so/status-effects.md) - [Analyzed], Battle Rage, etc.
- [Attribute System](https://www.notion.so/attribute-system.md) - MIGHT, FINESSE, WILL, STURDINESS

### Registry Entries

- [DiceService API](https://www.notion.so/03-technical-reference/service-architecture.md#diceservice)
- [EquipmentService API](https://www.notion.so/03-technical-reference/service-architecture.md#equipmentservice)
- [CombatEngine API](https://www.notion.so/03-technical-reference/combat-service-api.md)

### Technical References

- [Dice Pool Mechanics](https://www.notion.so/quick-reference/dice-pool-cheat-sheet.md) - Quick reference
- [Probability Tables](https://www.notion.so/05-balance-reference/hit-chance-tables.md) - Detailed probability analysis
