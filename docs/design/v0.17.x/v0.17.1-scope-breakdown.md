...
**Unit Tests (~2):**
- [x] Background enum has 6 values
- [x] BackgroundDefinition loads from configuration
...
**Unit Tests (~2):**
- [x] Village Smith grants Craft +2, Might +1
...
**Unit Tests (~2):**
- [x] Clan Guard starts with Shield and Spear
...
**Unit Tests (~2):**
- [x] GetAllBackgrounds returns 6 backgrounds
- [x] GetBackground returns correct definition
...
**Unit Tests (~2):**
- [x] ApplyBackgroundToCharacter grants skills correctly
- [x] ApplyBackgroundToCharacter grants equipment correctly
...
- [x] Background enum has 6 values
- [x] Each background has skill grants (primary +2, secondary +1)
- [x] Each background has equipment grants
- [x] Village Smith grants Craft +2, Might +1, Smith's Hammer, Leather Apron
- [x] Traveling Healer grants Medicine +2, Herbalism +1, Healer's Kit, Bandages ×5
- [x] Ruin Delver grants Exploration +2, Traps +1, Lantern, Rope, Lockpicks
- [x] Clan Guard grants Combat +2, Vigilance +1, Shield, Spear
- [x] Wandering Skald grants Performance +2, Lore +1, Instrument, Journal
- [x] Outcast Scavenger grants Survival +2, Stealth +1, Rations ×3, Cloak
- [x] Skills apply to character correctly
- [x] Equipment added to inventory correctly
- [x] Auto-equipped items are equipped correctly
