...
2. [Main Menu View](#2-main-menu-view)
3. [Combat View](#3-combat-view)
4. [Character Sheet View](#4-character-sheet-view)
5. [Dungeon Exploration View](#5-dungeon-exploration-view)
6. [Inventory & Equipment View](#6-inventory--equipment-view)
7. [Character Creation View](#7-character-creation-view)
8. [Settings View](#8-settings-view)
9. [Save/Load View](#9-saveload-view)
10. [Endgame Mode Selection View](#10-endgame-mode-selection-view)
11. [Victory Screen](#11-victory-screen)
12. [Death Screen](#12-death-screen)
13. [Minimap View](#13-minimap-view)
14. [Help Browser View](#14-help-browser-view)
15. [Specialization Tree View](#15-specialization-tree-view)
16. [Meta-Progression View](#16-meta-progression-view)
17. [Global Keyboard Shortcuts](#17-global-keyboard-shortcuts)
18. [UI Services & Controllers](#18-ui-services--controllers)
...
**Controller:** `LootController` (for post-combat)
...
**ViewModel:** `CharacterCreationViewModel.cs`
...
**ViewModel:** `VictoryScreenViewModel.cs`
...
**ViewModel:** `DeathScreenViewModel.cs`
...
**ViewModel:** `SpecializationTreeViewModel.cs`
