...
3. [Journal Main View](#3-journal-main-view)
4. [Glitching Interface System](#4-glitching-interface-system)
5. [Bestiary Section](#5-bestiary-section)
6. [Codex Section](#6-codex-section)
7. [Field Guide Section](#7-field-guide-section)
8. [The Log Section](#8-the-log-section)
9. [Dynamic Entry System](#9-dynamic-entry-system)
10. [Saga Integration](#10-saga-integration)
11. [Keyboard Shortcuts](#11-keyboard-shortcuts)
12. [Services & Controllers](#12-services--controllers)
...
**ViewModel:** `ScavengersJournalViewModel.cs`
**Controller:** `JournalController`
**View:** `ScavengersJournalView.axaml`
...
>
> *[Margin note in scratchy handwriting:]*
> *"They remember. They all remember. The Old Code still runs in their bones."*
...
*Related: GUI_SPECIFICATION.md (v0.45), QUEST_JOURNAL_SPECIFICATION.md (v1.0), DIALOGUE_SYSTEM_SPECIFICATION.md*
