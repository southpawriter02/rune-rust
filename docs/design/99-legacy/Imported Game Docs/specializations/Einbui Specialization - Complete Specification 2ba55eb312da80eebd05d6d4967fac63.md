...
1. Implement hidden Resource Node system
2. Implement resource reveal mechanic
3. Implement environmental hazard resistance

### Phase 3: Rest & Expedition

1. Implement Ration consumption reduction
2. Implement Wilderness Rest integration
3. Implement Blight Haven safe room designation

### Phase 4: Polish

1. Add rank-specific skill check bonuses
2. Implement Universal Competence
3. Add [Hidden Camp] status tracking
