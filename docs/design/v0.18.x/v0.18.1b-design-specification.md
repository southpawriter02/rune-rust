...
- [ ] `src/Core/RuneAndRust.Domain/Entities/CorruptionTracker.cs`

### Domain Layer — Value Objects

- [ ] `src/Core/RuneAndRust.Domain/ValueObjects/CorruptionAddResult.cs`
- [ ] `src/Core/RuneAndRust.Domain/ValueObjects/TerminalErrorResult.cs`

### Unit Tests

- [ ] `tests/RuneAndRust.Domain.UnitTests/Entities/CorruptionTrackerTests.cs`
- [ ] `tests/RuneAndRust.Domain.UnitTests/ValueObjects/CorruptionAddResultTests.cs`
- [ ] `tests/RuneAndRust.Domain.UnitTests/ValueObjects/TerminalErrorResultTests.cs`

### Documentation

- [ ] XML documentation on all public members
- [ ] Code examples in remarks sections
- [ ] Update scope breakdown to mark v0.18.1b complete
...
- [ ] `CorruptionTracker.MaxHpPenaltyPercent` equals `floor(Corruption/10) × 5`
- [ ] `CorruptionTracker.MaxApPenaltyPercent` equals `floor(Corruption/10) × 5`
- [ ] `CorruptionTracker.ResolveDicePenalty` equals `floor(Corruption/20)`
- [ ] `CorruptionTracker.TechBonus` returns stage-appropriate bonus (0/+1/+2)
- [ ] `CorruptionTracker.SocialPenalty` returns stage-appropriate penalty (0/-1/-2)
- [ ] `CorruptionTracker.IsFactionLocked` is `true` when corruption ≥ 50
- [ ] `CorruptionTracker.IsTerminalError` is `true` when corruption = 100
- [ ] Threshold 25/50/75 crossings trigger exactly once per character
- [ ] `CorruptionAddResult` correctly captures stage transitions
- [ ] `TerminalErrorResult.Success` sets corruption to 99
- [ ] `TerminalErrorResult.Failure` marks character as Forlorn
