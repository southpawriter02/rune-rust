...
- [ ] Migration file: `YYYYMMDD_AddPsychicStress.cs`

### Domain Layer

- [ ] `src/Core/RuneAndRust.Domain/Entities/StressHistoryEntry.cs`

### Application Layer

- [ ] `src/Core/RuneAndRust.Application/Interfaces/IStressHistoryRepository.cs`

### Infrastructure Layer

- [ ] `src/Infrastructure/RuneAndRust.Infrastructure/Data/Configurations/StressHistoryEntryConfiguration.cs`
- [ ] `src/Infrastructure/RuneAndRust.Infrastructure/Repositories/StressHistoryRepository.cs`

### Unit Tests

- [ ] `tests/RuneAndRust.Domain.UnitTests/Entities/StressHistoryEntryTests.cs`
...
- [ ] `psychic_stress` column added to `character_resources`
- [ ] CHECK constraint enforces 0-100 range
- [ ] `stress_history` table created with all columns
- [ ] Index on `(character_id, created_at)` created
- [ ] `StressHistoryEntry` records stress applications
- [ ] History entries include resistance check details
- [ ] Threshold crossings recorded in history
- [ ] History queryable by character ID
