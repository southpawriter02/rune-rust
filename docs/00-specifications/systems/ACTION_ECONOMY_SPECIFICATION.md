...
3. [Exploration Action Economy](#3-exploration-action-economy)
4. [Combat Action Economy](#4-combat-action-economy)
5. [World Clock Integration](#5-world-clock-integration)
6. [Resource Costs](#6-resource-costs)
7. [Action Modifiers](#7-action-modifiers)
...
*Related: PHYSICAL_INTERACTION_SPECIFICATION.md, SPEC-COMBAT-001*
