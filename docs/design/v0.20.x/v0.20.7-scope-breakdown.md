...
> _"Every creature leaves a trail. Every trail has an end."_
...
- [x] Tier 2 abilities locked until 8 PP invested in tree
- [x] Each Tier 2 ability costs 4 PP to unlock
- [x] Hunter's Eye allows ranged attacks to ignore partial cover
- [x] Hunter's Eye is passive (no AP cost, no duration — evaluated per attack; adapted from spec's 3-turn model)
- [x] Trap Mastery can place traps (2 AP) dealing 1d8 + immobilize (adapted from spec's 3 AP)
- [x] Trap Mastery can detect traps (2 AP) with +3 bonus (+4 with Keen Senses) (adapted from spec's 1 AP / +5)
- [x] Maximum 2 traps can be active at once
- [x] Predator's Patience grants +3 to hit if no movement
- [x] Predator's Patience bonus lost if any movement occurs
- [x] Stance bonuses stack with Quarry Mark (independent systems — both apply)
- [x] No Corruption risk for any abilities
- [x] 115 unit tests pass (63 domain VO + 52 service; exceeds ~8 target)
...
- [x] Tier 3 abilities locked until 16 PP invested in tree
- [x] Capstone locked until 24 PP invested in tree
- [x] Tier 3 abilities cost 5 PP each to unlock
- [x] Capstone costs 6 PP to unlock
- [x] Apex Predator denies concealment to marked Quarry
- [x] Apex Predator works against darkness, invisibility, fog
- [x] Crippling Shot halves target movement for 2 turns
- [x] Crippling Shot deals normal weapon damage on hit
- [x] The Perfect Hunt requires marked Quarry target
- [x] The Perfect Hunt makes next attack automatic critical
- [x] The Perfect Hunt doubles damage dice only
- [x] The Perfect Hunt is once per long rest
- [x] No Corruption risk for any abilities
- [x] ~7 unit tests pass (actual: 61 new tests, 176 total Veiðimaðr)
...
```
┌─────────────────────────────────────────────────────────────────┐
│               v0.20.7 Veiðimaðr Specialization                   │
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │                    Domain Layer                          │   │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │   │
│  │  │   Quarry     │  │  MarkQuarry  │  │  ReadSigns   │  │   │
│  │  │   Marks      │  │   Result     │  │   Result     │  │   │
│  │  │   Resource   │  │ Value Object │  │ Value Object │  │   │
│  │  └──────────────┘  └──────────────┘  └──────────────┘  │   │
│  │                                                          │   │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │   │
│  │  │  HuntersEye  │  │    Trap      │  │   Crippling  │  │   │
│  │  │   State      │  │  Mastery     │  │    Shot      │  │   │
│  │  │ Value Object │  │   Result     │  │   Result     │  │   │
│  │  └──────────────┘  └──────────────┘  └──────────────┘  │   │
│  │                                                          │   │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │   │
│  │  │   Apex       │  │  PerfectHunt │  │ Veiðimaðr   │  │   │
│  │  │  Predator    │  │   Result     │  │  AbilityId   │  │   │
│  │  │   State      │  │ Value Object │  │    Enum      │  │   │
│  │  └──────────────┘  └──────────────┘  └──────────────┘  │   │
│  └─────────────────────────────────────────────────────────┘   │
│                              │                                   │
│                              ▼                                   │
...
│  │                  Application Layer                       │   │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │   │
│  │  │  IQuarry     │  │ IVeiðimaðr  │  │    ITrap     │  │   │
│  │  │   Marks      │  │   Ability    │  │   Service    │  │   │
│  │  │   Service    │  │   Service    │  │              │  │   │
│  │  └──────────────┘  └──────────────┘  └──────────────┘  │   │
│  │         │                  │                  │         │   │
│  │         ▼                  ▼                  ▼         │   │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │   │
│  │  │   Quarry     │  │ Veiðimaðr   │  │    Trap      │  │   │
│  │  │   Marks      │  │   Ability    │  │   Service    │  │   │
...
Quarry Marks Resource Flow:
┌─────────────┐   Mark Quarry      ┌─────────────┐                ┌─────────────┐
│   Target    │ ─────────────────► │   Quarry    │ ──────────────►│  Targeted   │
│  Selection  │  +1 Mark (max 3)   │   Marks     │  Bonus Applied │  Abilities  │
└─────────────┘                    └─────────────┘                └─────────────┘
                                          │
                                          ▼ Consume All
                                   ┌─────────────┐
...
- [x] Apex Predator passive integration
- [x] Crippling Shot ability handler
- [x] The Perfect Hunt ability handler

### Infrastructure Layer

- [ ] `specializations.json` Veiðimaðr entry
- [x] `abilities.json` Veiðimaðr abilities (9 total)
...
- [x] Tier3AndCapstoneTests.cs (~7 tests → actual: 61 new tests across 5 test files)
