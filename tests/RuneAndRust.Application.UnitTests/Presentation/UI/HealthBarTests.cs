...
/// <summary>
/// Unit tests for <see cref="HealthBar"/>.
/// </summary>
[TestFixture]
public class HealthBarTests
{
    ...
    {
        // Act
        var bar = _healthBar.Render(100, 100, 10, BarStyle.Standard);
    ...
    {
        // Act
        var bar = _healthBar.Render(50, 100, 10, BarStyle.Standard);
    ...
    {
        // Act
        var bar = _healthBar.Render(0, 100, 10, BarStyle.Standard);
    ...
    {
        // Act
        var bar = _healthBar.Render(80, 100, 10, BarStyle.Detailed);
    ...
    {
        // Act
        var bar = _healthBar.Render(50, 100, 10, BarStyle.Compact);
    ...
    {
        // Act
        var bar = _healthBar.Render(75, 100, 10, BarStyle.Numeric);
    ...
    public void Render_WithAsciiFallback_UsesAsciiCharacters()
    {
        ...
        var healthBar = new HealthBar(_mockTerminal.Object);
    ...
    {
        // Act
        var bar = _healthBar.RenderLabeled("HP", 80, 100, 30);
    ...
    public void RenderLabeled_NarrowWidth_ReturnsNumericOnly()
    {
        ...
        var bar = _healthBar.RenderLabeled("HP", 80, 100, 15);
    ...
    {
        // Act
        var color = _healthBar.GetThresholdColor(100, 100, BarType.Health);
    ...
    {
        // Act - 50% health
        var color = _healthBar.GetThresholdColor(50, 100, BarType.Health);
    ...
    {
        // Act - 25% health
        var color = _healthBar.GetThresholdColor(25, 100, BarType.Health);
    ...
    {
        // Act - 10% health
        var color = _healthBar.GetThresholdColor(5, 100, BarType.Health);
    ...
    {
        // Act
        var color = _healthBar.GetThresholdColor(50, 100, BarType.Mana);
    ...
    {
        // Act
        var color = _healthBar.GetThresholdColor(50, 100, BarType.Experience);
    ...
    {
        // Act
        var act = () => _healthBar.Render(-1, 100, 10);
    ...
    {
        // Act
        var act = () => _healthBar.Render(50, 0, 10);
    ...
    {
        // Act
        var act = () => _healthBar.Render(50, 100, 2);
