...
### Cross-Cutting Reference Documents (`reference/`)

These are **shared data registries** consumed incrementally by v0.19.1–v0.19.6. They are not separate implementation phases. See `reference/README.md` for reading order.

| Document                           | Purpose                                                       | Consumed By                 |
| ---------------------------------- | ------------------------------------------------------------- | --------------------------- |
| `reference/lore-reconciliation.md` | Master bridge between lore and implementation scope           | All versions                |
| `reference/enemy-translation.md`   | Lore enemies → monster definitions with IDs, stats, abilities | v0.19.1–v0.19.5 (per biome) |
| `reference/hazard-registry.md`     | Zone-specific hazard specifications                           | v0.19.1–v0.19.5 (per biome) |
| `reference/room-templates.md`      | 124 room templates with biome/zone assignments                | v0.19.1–v0.19.5 (per biome) |
| `reference/descriptor-system.md`   | Thematic modifiers, sounds, description templates             | v0.19.6b (integration)      |
...
> _"We do not fear the dark. We are the dark."_
...
> _"The kidney of Aethelgard learned to vomit."_
...
> _"The fire does not hate you. It simply cannot stop burning."_
...
> _"The cold preserves everything. Even madness."_
...
> _"Built for giants. Abandoned by all."_
...
> _"The garden that tends itself—and anything that enters it."_
...
> _"Reality is a suggestion in Alfheim."_
...
> _"The tomb does not know its occupant is dead."_
