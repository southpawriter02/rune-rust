...
5. **Implement Scout Drone pet** - HP, movement, vision
6. **Implement pet command system** - Move, special abilities
7. **Implement target marking** (Scout Drone Rank 2)
8. **Implement self-destruct mechanic**

### Phase 3: Combat Integration
9. **Implement trap system** - Hidden placement, trigger detection
10. **Implement AoE ground targeting** (Flash Bomb)
11. **Route Scrap-Tinker abilities** through CombatEngine

### Phase 4: Crafting System
12. **Implement weapon modification** - Elemental, Precision, Reinforced
13. **Implement mod stacking** (Rank 3)
14. **Implement crafting time reduction**

### Phase 5: Scrap Golem
15. **Implement Scrap Golem pet** - Full stat block
16. **Implement multi-ability pets** - Slam, Defend, Repair, Detonate
17. **Implement expedition-long duration**

### Phase 6: Polish
18. **Add deployed pets panel** to CombatView
19. **Add Scrap Materials tracker** to UI
20. **Implement crafting quality indicators**
