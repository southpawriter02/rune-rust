# Changelog: v0.0.4 - The Persistence (Database Integration)
...
- [Logging Matrix (v0.0.4)](#logging-matrix-v004)
- [Test Summary by Category](#test-summary-by-category)
- [Build Verification](#build-verification)
- [Directory Structure After v0.0.4](#directory-structure-after-v004)
- [Database Schema](#database-schema)
- [Database Setup Instructions](#database-setup-instructions)
- [Commands Reference (Updated)](#commands-reference-updated)
- [Next Steps (v0.0.5: The Spatial Core)](#next-steps-v005-the-spatial-core)
