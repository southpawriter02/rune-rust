...
**File Path:** `RuneAndRust.Engine/DungeonGenerator.cs`**Version:** v0.39.4
...
- [Procedural Generation](https://www.notion.so/PROCEDURAL_GENERATION.md) - High-level generation overview
- [PopulationPipeline](https://www.notion.so/population-pipeline.md) - Room population system

### Related Services

- [TemplateLibrary](https://www.notion.so/template-library.md) - Room template definitions
- [PopulationPipeline](https://www.notion.so/population-pipeline.md) - Enemy/hazard spawning
- [BiomeLibrary](https://www.notion.so/biome-library.md) - Biome definitions
- [SpatialLayoutService](https://www.notion.so/spatial-layout-service.md) - 3D positioning
