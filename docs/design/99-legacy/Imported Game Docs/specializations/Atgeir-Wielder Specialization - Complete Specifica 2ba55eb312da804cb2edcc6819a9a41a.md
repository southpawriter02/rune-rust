...
1. **Implement opposed checks** - MIGHT vs STURDINESS for Push/Pull
2. **Implement stance system** - Duration-based buffs with restrictions
3. **Route Atgeir-Wielder abilities** through CombatEngine

### Phase 3: Advanced Mechanics

1. **Implement aura system** - Adjacent ally bonuses
2. **Implement Zone of Control** - Enemy debuffs in opposing row
3. **Implement reactive abilities** - Brace for Charge as Reaction

### Phase 4: Status Effects

1. **Define status effects** ([Slowed], [Off-Balance], [Disciplined Stance])
2. **Implement movement restriction** for Zone of Control
3. **Implement counter-attack triggers**

### Phase 5: Polish

1. **Add rank-specific icons** (Bronze/Silver/Gold)
2. **Implement row position indicators**
3. **Add [Reach] targeting visualization**
