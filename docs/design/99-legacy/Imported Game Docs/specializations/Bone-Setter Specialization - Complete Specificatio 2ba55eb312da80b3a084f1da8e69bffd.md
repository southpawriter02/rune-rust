...
1. **Implement [Vulnerable]** status fully
2. **Implement [Death Ward]** mechanic
3. **Implement Triage** auto-stabilize

### Phase 3: GUI

1. **Add rank indicators** (Bronze/Silver/Gold)
2. **Add consumable tracking** UI
3. **Add crafting interface**
