...
**File Path:** `RuneAndRust.Engine/CombatEngine.cs` (lines 1200-1416), `RuneAndRust.Core/PlayerCharacter.cs`, `RuneAndRust.Core/Enemy.cs`
**Version:** v0.1-v0.16
...
**Environmental Hazards** (various, see [Environmental Hazards](./environmental-hazards.md))
```
...
### Related Systems
- [Combat Resolution System](./combat-resolution.md) - Status effects integrated into combat flow
- [Damage Calculation System](./damage-calculation.md) - Status modifiers affect damage
- [Accuracy & Evasion System](./accuracy-evasion.md) - [Analyzed], Battle Rage affect accuracy
- [Ability System](./ability-system.md) - Abilities apply status effects

### Registry Entries
- See [Abilities Registry](../02-statistical-registry/abilities-registry.md) for abilities that apply status effects
- See [Status Effects Registry](../02-statistical-registry/status-effects-registry.md) for complete status list

### Technical References
- [CombatEngine API](../03-technical-reference/combat-service-api.md#status-effects)
- [PlayerCharacter Model](../03-technical-reference/database-schema.md#playercharacter)
- [Enemy Model](../03-technical-reference/database-schema.md#enemy)
