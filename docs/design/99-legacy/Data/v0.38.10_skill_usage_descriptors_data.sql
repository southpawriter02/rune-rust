...
INSERT INTO Skill_Check_Descriptors (skill_type, action_type, check_phase, result_degree, environmental_context, descriptor_text, weight, tags) VALUES
('SystemBypass', 'Lockpicking', 'Success', 'Minimal', NULL, 'After several tense minutes, the lock finally yields. Your hands are cramping.', 1.0, '["Verbose", "Struggle"]'),
...
('SystemBypass', 'Lockpicking', 'CriticalSuccess', 'Critical', NULL, 'The lock opens in seconds. Child''s play.', 1.0, '["Concise"]'),
...
('SystemBypass', 'Lockpicking', 'Failure', 'Solid', NULL, 'After several minutes of fruitless effort, you accept that this lock is too advanced.', 1.0, '["Verbose"]'),
...
INSERT INTO Skill_Check_Descriptors (skill_type, action_type, check_phase, result_degree, environmental_context, descriptor_text, weight, tags) VALUES
('SystemBypass', 'TerminalHacking', 'Attempt', NULL, NULL, 'You interface with the terminal, your fingers flying across the corrupted input device.', 1.0, '["Technical"]'),
('SystemBypass', 'TerminalHacking', 'Attempt', NULL, NULL, 'The terminal flickers to life as you access its systems.', 1.0, '["Concise"]'),
('SystemBypass', 'TerminalHacking', 'Attempt', NULL, NULL, 'You begin to navigate the ancient operating system, looking for access points.', 1.0, '["Technical"]'),
...
('SystemBypass', 'TerminalHacking', 'Attempt', NULL, 'GlitchedTerrain', 'Blight corruption has warped the terminal''s code. Logic doesn''t work the way it should.', 1.0, '["Verbose", "Blight"]'),
...
-- Success Descriptors
INSERT INTO Skill_Check_Descriptors (skill_type, action_type, check_phase, result_degree, environmental_context, descriptor_text, weight, tags) VALUES
('SystemBypass', 'TerminalHacking', 'Success', 'Minimal', NULL, 'You barely force your way through the system''s defenses. Access granted, but it wasn''t pretty.', 1.0, '["Verbose"]'),
...
('SystemBypass', 'TerminalHacking', 'Success', 'Solid', NULL, 'You navigate the system efficiently. Within minutes, you have full access.', 1.0, '["Concise"]'),
...
('SystemBypass', 'TerminalHacking', 'CriticalSuccess', 'Critical', NULL, 'You slice through the security like it wasn''t even there. Root access achieved.', 1.0, '["Dramatic"]'),
...
('SystemBypass', 'TerminalHacking', 'TimeWasted', 'Moderate', 10, 1, 'Access denied. The terminal locks you out completely. [Cannot retry for 10 minutes]', 1.0, '["Frustrating"]'),
...
('Acrobatics', 'Climbing', 'Success', 'Solid', NULL, 'Your route up is well-chosen. Within minutes, you reach the top.', 1.0, '["Concise"]'),
...
('Acrobatics', 'Leaping', 'Attempt', NULL, 'GlitchedTerrain', 'The gap flickers—is it three meters or ten? Coherent Glitches make this treacherous.', 1.0, '["Blight", "Dramatic"]'),
...
INSERT INTO Skill_Check_Descriptors (skill_type, action_type, check_phase, result_degree, environmental_context, descriptor_text, weight, tags) VALUES
('WastelandSurvival', 'Tracking', 'Attempt', NULL, 'FreshTracks', 'Fresh tracks in the rust-dust. Something passed through here within the hour.', 1.0, '["Technical"]'),
...
('WastelandSurvival', 'Tracking', 'CriticalSuccess', 'Critical', NULL, 'You can tell they stopped here to rest exactly 3 hours ago. You''re gaining on them.', 1.0, '["Dramatic", "Technical"]');
...
('WastelandSurvival', 'Tracking', 'Failure', 'Solid', NULL, 'You follow the tracks for an hour before realizing they''re the wrong ones. You''ve wasted time.', 1.0, '["Frustrating"]'),
...
('WastelandSurvival', 'Navigation', 'TimeWasted', 'Moderate', 180, 'You take a wrong turn. It takes hours to realize and backtrack. [Lost 3 hours]', 1.0, '["Frustrating"]'),
('WastelandSurvival', 'Navigation', 'TimeWasted', 'Moderate', 60, 'You''re temporarily lost. Eventually you find your way, but you''ve wasted time. [Lost 1 hour]', 1.0, '["Frustrating"]'),
