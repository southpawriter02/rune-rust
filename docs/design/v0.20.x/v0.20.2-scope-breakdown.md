...
> _"Every mark tells a truth. Every truth holds power."_
...
```
┌─────────────────────────────────────────────────────────────────┐
│               v0.20.2 Rúnasmiðr Specialization                   │
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │                    Domain Layer                          │   │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │   │
│  │  │    Rune      │  │  Inscribe    │  │   Runestone  │  │   │
│  │  │  Charges     │  │   Rune       │  │    Ward      │  │   │
│  │  │  Resource    │  │   Result     │  │   Result     │  │   │
│  │  └──────────────┘  └──────────────┘  └──────────────┘  │   │
│  │                                                          │   │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │   │
│  │  │   Rune       │  │  RuneChain   │  │  Empowered   │  │   │
│  │  │  Mastery     │  │   Result     │  │   Glyph      │  │   │
...
│  │                  Application Layer                       │   │
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  │   │
│  │  │    IRune     │  │ IRúnasmiðr  │  │    IRune     │  │   │
│  │  │  Charges     │  │   Ability    │  │  Inscription │  │   │
...
Rune Charges Resource Flow:
┌─────────────┐   Inscribe Rune    ┌─────────────┐                ┌─────────────┐
│   Object    │ ─────────────────► │    Rune     │ ──────────────►│   Rune      │
│  or Surface │  Create Charge     │  Charges    │  Spend Charge  │  Abilities  │
└─────────────┘                    └─────────────┘                └─────────────┘
                                          │
                                          ▼ Consume All
                                   ┌─────────────┐
...
_This scope breakdown provides a structured approach to implementing the Rúnasmiðr specialization. Each sub-phase builds on the previous, allowing for incremental development and testing of the crafting-focused runesmith archetype._
