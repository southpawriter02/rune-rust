...
### Navigation Commands
3. **RuneAndRust.Engine/Commands/LookCommand.cs** (~280 lines)
...
4. **RuneAndRust.Engine/Commands/GoCommand.cs** (~100 lines)
...
5. **RuneAndRust.Engine/Commands/InvestigateCommand.cs** (~280 lines)
...
6. **RuneAndRust.Engine/Commands/SearchCommand.cs** (~230 lines)
...
### Testing
7. **RuneAndRust.Tests/NavigationCommandsTests.cs** (~400 lines)
...
### Database Schema
8. **Data/v0.37.1_navigation_schema.sql** (~170 lines)
...
4. **RuneAndRust.Engine/LootService.cs**
...
**Syntax:** `go [direction]`
**Aliases:** g, move, n, s, e, w, north, south, east, west
