...
1. **Implement [Feared] status** - flee behavior
2. **Implement bonus damage** vs Feared targets
3. **Implement Terror Feedback** - resource restoration

### Phase 3: Capstone

1. **Implement Silence Made Weapon** - scaling damage
2. **Implement forced teleportation** (Echo Displacement)
3. **Add Psychic Stress costs**
