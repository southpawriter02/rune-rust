...
- [ ] Attribute descriptions load correctly
...
**Unit Tests (~2):**
- [ ] Simple mode applies correct recommended build
...
**Unit Tests (~3):**
- [ ] Cost from 1 to 8 is 7 points
- [ ] Cost from 8 to 10 is 4 points (2 + 2)
- [ ] Decreasing attribute refunds correct amount
...
**Unit Tests (~3):**
- [ ] Warrior HP calculation correct (139 with standard build)
- [ ] Mystic AP calculation correct (80 with standard build)
