...
**File Path:** `RuneAndRust.Engine/PopulationPipeline.cs`
**Version:** v0.39.3
...
- [DungeonGenerator](./dungeon-generator.md) - Calls PopulationPipeline
- [CoherentGlitchRuleEngine](./coherent-glitch-rule-engine.md) - Modifies spawn weights

### Related Services

- [HazardSpawner](./hazard-spawner.md) - Hazard placement logic
- [LootSpawner](./loot-spawner.md) - Loot placement logic
- [BiomeLibrary](./biome-library.md) - Biome spawn tables
