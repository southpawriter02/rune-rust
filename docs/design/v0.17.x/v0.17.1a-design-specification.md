...
- [ ] `Background.cs` enum created in `src/Core/RuneAndRust.Domain/Enums/`
- [ ] `BackgroundDefinition.cs` entity created in `src/Core/RuneAndRust.Domain/Entities/`
- [ ] All types have complete XML documentation

### Configuration Files

- [ ] `config/backgrounds.json` created with all 6 backgrounds (partial - definition only)
- [ ] `config/schemas/backgrounds.schema.json` created
- [ ] Configuration validates against schema

### Testing

- [ ] `BackgroundTests.cs` created
- [ ] `BackgroundDefinitionTests.cs` created
- [ ] ~8 unit tests passing

### Documentation

- [ ] `v0.17.1a-changelog.md` created
