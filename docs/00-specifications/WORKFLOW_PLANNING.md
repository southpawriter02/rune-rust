...
2. [Planning Workflow Overview](#planning-workflow-overview)
3. [Step 1: Understand the Assignment](#step-1-understand-the-assignment)
4. [Step 2: Explore the Codebase](#step-2-explore-the-codebase)
5. [Step 3: Map System Relationships](#step-3-map-system-relationships)
6. [Step 4: Define Scope & Requirements](#step-4-define-scope--requirements)
7. [Step 5: Identify Mechanics & Formulas](#step-5-identify-mechanics--formulas)
8. [Step 6: Check Setting Compliance](#step-6-check-setting-compliance)
9. [Step 7: Present Plan for Approval](#step-7-present-plan-for-approval)
10. [Planning Outputs & Next Steps](#planning-outputs--next-steps)
11. [Common Planning Pitfalls](#common-planning-pitfalls)
12. [Planning Checklist](#planning-checklist)
