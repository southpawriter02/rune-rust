...
**File Path:** `RuneAndRust.Engine/CombatEngine.cs`**Version:** v0.1-v0.16 (evolved across versions)
...
- [Damage Calculation System](https://www.notion.so/damage-calculation.md) - How damage is calculated and applied
- [Accuracy & Evasion System](https://www.notion.so/accuracy-evasion.md) - Attack success determination
- [Status Effects System](https://www.notion.so/status-effects.md) - Buffs, debuffs, DoT mechanics
- [Ability System](https://www.notion.so/ability-system.md) - Special actions in combat
- [Equipment System](https://www.notion.so/equipment-system.md) - Equipment stat bonuses affect combat

### Registry Entries

- [DiceService](https://www.notion.so/03-technical-reference/service-architecture.md#diceservice) - Random number generation
- [CombatEngine](https://www.notion.so/03-technical-reference/combat-service-api.md) - Complete API reference
- [PlayerCharacter](https://www.notion.so/03-technical-reference/database-schema.md#playercharacter) - Player model
- [Enemy](https://www.notion.so/03-technical-reference/database-schema.md#enemy) - Enemy model

### Technical References

- [Service Architecture](https://www.notion.so/03-technical-reference/service-architecture.md) - How CombatEngine fits into service layer
- [Data Flow](https://www.notion.so/03-technical-reference/data-flow.md#combat-turn-resolution) - Complete combat data flow
