...
- [System A](https://www.notion.so/01-systems/system-a.md) - [How they relate]
- [System B](https://www.notion.so/01-systems/system-b.md) - [How they relate]

### Registry Entries

- [Ability X](https://www.notion.so/02-statistical-registry/abilities-registry.md#ability-x) - Uses this system
- [Equipment Y](https://www.notion.so/02-statistical-registry/equipment-registry.md#equipment-y) - Modified by this system

### Technical References

- [Service Architecture](https://www.notion.so/03-technical-reference/service-architecture.md#%5Bservice-name%5D)
- [Database Schema](https://www.notion.so/03-technical-reference/database-schema.md#%5Btable-name%5D)
