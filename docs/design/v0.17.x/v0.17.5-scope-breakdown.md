...
├── Summary (Step 6) - Review & name entry
```
...
├── FlexibleAttributeBonus: CoreAttribute? (for Clan-Born)
├── // Step 2 - Background
├── SelectedBackground: Background?
├── // Step 3 - Attributes
├── AttributeAllocationMode: AttributeAllocationMode
├── Attributes: AttributeAllocationState
├── // Step 4 - Archetype
...
│                                                     │
│  Step 1: Lineage                                    │
│    - Select lineage → Stored in state              │
│    - If Clan-Born: Select flexible attribute       │
│                                                     │
│  Step 2: Background                                 │
│    - Select background → Stored in state           │
│                                                     │
│  Step 3: Attributes                                 │
│    - Simple/Advanced mode selection                │
│    - Point-buy or recommended build                │
│    - Live preview of derived stats                 │
│                                                     │
│  Step 4: Archetype (PERMANENT)                     │
│    - Select archetype → Cannot be undone           │
│    - Determines specialization options             │
│                                                     │
│  Step 5: Specialization                            │
│    - Select from archetype's available options     │
...
├── CanGoBack: bool
├── CanGoForward: bool
├── IsPermanentChoice: bool
├── // Preview Data
├── DerivedStatsPreview: DerivedStats?
├── AbilitiesPreview: List<string>?
├── EquipmentPreview: List<string>?
├── // Validation
├── ValidationErrors: List<string>
...
├── MinLength: int (2)
├── MaxLength: int (20)
├── AllowedPattern: Regex (ASCII letters, spaces, hyphens)
├── ProfanityFilter: List<string>
```
...
├── IsValid: bool
├── ErrorMessage: string?
├── SuggestedName: string? (if invalid)
```
...
║      +5 Maximum HP | +1 Social Skill | +1 Any Attribute  ║
║                                                           ║
║  [2] RUNE-MARKED                                          ║
║      "The Aether sang in your blood from birth"          ║
║      +5 Maximum Aether Pool | +1 Lore Skill              ║
║      +2 WILL | -1 STURDINESS | Starts with 5 Corruption  ║
║                                                           ║
║  [3] IRON-BLOODED                                         ║
...
╠═══════════════════════════════════════════════════════════╣
║                                                           ║
║  ⚠ WARNING: This choice is PERMANENT and cannot be       ║
║    changed after character creation.                      ║
║                                                           ║
...
║  ARCHETYPE:      Warrior                                  ║
║  SPECIALIZATION: Skjaldmaer (Coherent)                    ║
║  ─────────────────────────────────────────────────────── ║
║  ATTRIBUTES:                                              ║
...
**Unit Tests (~2):**
- [x] Character persists to storage correctly
- [x] All fields saved with correct values
...
- [x] Character persists to storage on confirm
