...
- [ ] `IAttributeProvider` interface created with 5 methods
- [ ] `AttributeProvider` implementation created
- [ ] Configuration loading from `attributes.json`
- [ ] Caching of descriptions and builds
...
- [ ] `GetAttributeDescription()` returns correct data for all 5 attributes
- [ ] `GetAllAttributeDescriptions()` returns exactly 5 descriptions
- [ ] `GetRecommendedBuild("warrior")` returns M4, F3, Wi2, Wl2, S4
- [ ] `GetStartingPoints("adept")` returns 14
- [ ] `GetStartingPoints(null)` returns 15
- [ ] Unknown archetype throws `ArgumentException`
