...
1. **Sensory Discipline** (Passive) - +2/+3/+4 dice vs Fear/Disoriented
2. **Shattering Wave** (Active) - 60%/75%/85% Stun OR guaranteed Stagger
3. **Resonant Tremor** (Active) - 3x3/4x4/5x5 Difficult Terrain zone

### Tier 3 (5 PP each)

1. **Earthen Grasp** (Active) - AoE Root + 2d6/3d6/4d6 damage
2. **Inner Stillness** (Passive) - Mental immunity + ally aura protection

### Capstone (6 PP)

1. **Earthshaker** (Active) - 4d8/5d8/6d10+MIGHT AoE, Knocked Down, permanent terrain
