...
**Feature Branch:** `claude/advanced-status-effect-interactions-01WC1W3y9xzfddHDqSPmBzvN`
**Specification Version:** v5.0
**Status:** ✅ Complete
...
3. **StatusEffectRepository.cs** (NEW)
...
4. **AdvancedStatusEffectService.cs** (NEW)
   - **Stacking Management**
...
5. **AdvancedStatusEffectServiceTests.cs** (NEW)
