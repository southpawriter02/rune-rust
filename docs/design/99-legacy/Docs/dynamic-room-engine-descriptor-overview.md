...
2. [The Three-Tier Composition Model](#the-three-tier-composition-model)
3. [Component Breakdown](#component-breakdown)
4. [The Composition Pipeline](#the-composition-pipeline)
5. [Placeholder System](#placeholder-system)
6. [Fragment Selection](#fragment-selection)
7. [Complete Generation Flow](#complete-generation-flow)
8. [Example Compositions](#example-compositions)
9. [System Statistics](#system-statistics)
