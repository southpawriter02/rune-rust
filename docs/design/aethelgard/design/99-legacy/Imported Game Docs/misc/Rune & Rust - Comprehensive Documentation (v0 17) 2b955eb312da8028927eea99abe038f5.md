...
### 📐 [00 - Feature & System Specifications](https://www.notion.so/00-specifications/)
...
- [**START_HERE.md**](https://www.notion.so/00-specifications/START_HERE.md) - Quick start for AI sessions drafting new specs
- [**SPEC_BACKLOG.md**](https://www.notion.so/00-specifications/SPEC_BACKLOG.md) - Registry of all specs (3 completed, 34 planned, 37 total)
- [**Specification Writing Guide**](https://www.notion.so/00-specifications/README.md) - Complete governance, standards, and templates

### 📖 [01 - System Documentation](https://www.notion.so/01-systems/)
...
### 📊 [02 - Statistical Registry](https://www.notion.so/02-statistical-registry/)
...
### 🔧 [03 - Technical Reference](https://www.notion.so/03-technical-reference/)
...
### ✅ [04 - Testing & QA](https://www.notion.so/04-testing-qa/)
...
### ⚖️ [05 - Balance Reference](https://www.notion.so/05-balance-reference/)
...
### ⚡ [Quick Reference](https://www.notion.so/quick-reference/)
...
👉 **NEW: Read Specifications First**: [Specification Writing Guide](https://www.notion.so/00-specifications/README.md)
👉 **Browse Core Specifications**: [Combat Resolution](https://www.notion.so/00-specifications/combat/combat-resolution-spec.md) | [Character Progression](https://www.notion.so/00-specifications/progression/character-progression-spec.md) | [Trauma Economy](https://www.notion.so/00-specifications/economy/trauma-economy-spec.md)
👉 **Then Reference Implementation**: [System Documentation](https://www.notion.so/01-systems/)
👉 **Browse Ability Registry**: [Abilities](https://www.notion.so/02-statistical-registry/)
👉 **Check Test Coverage**: [Testing & QA](https://www.notion.so/04-testing-qa/)

---

**v0.17: Document before you balance — establish ground truth for all systems.**

*Generated: 2025-11-12Status: 🚧 In Progress*