...
VALUES
('Paradox', 'Minor', NULL, NULL, 'The rune you summon isn''t quite right—it flickers between states. The weaving works, but reality protests.', '{"damage": 0, "random_effect": "minor_glitch"}', 1.0, '["Reality-Bending", "Subtle"]'),
...
INSERT INTO Galdr_Miscast_Descriptors (miscast_type, severity, rune_school, ability_name, descriptor_text, mechanical_effect, weight, tags)
VALUES
('Backlash', 'Minor', NULL, NULL, 'The Galdr fizzles, the rune-light fading harmlessly. You feel drained.', '{"ap_loss": 5}', 1.0, '["Harmless", "Draining"]'),
('Backlash', 'Moderate', 'Fehu', 'FlameBolt', 'AethericOverload', 'The Galdr recoils! Fire lashes back at you! You stumble, singed and disoriented!', '{"damage": 5, "status": "Burning", "duration": 2, "target": "Self"}', 1.0, '["Painful"]'),
...
('Backlash', 'Catastrophic', NULL, NULL, 'The Aether itself rebels! Galdr explodes outward in all directions—friend and foe alike caught in the blast!', '{"damage": 12, "target": "Area", "affects": "All"}', 0.5, '["Devastating", "Indiscriminate"]');
...
INSERT INTO Galdr_Miscast_Descriptors (miscast_type, severity, rune_school, ability_name, descriptor_text, mechanical_effect, weight, tags)
VALUES
('Fizzle', 'Minor', NULL, NULL, 'The invocation fizzles as the {Rune} resists your will. Nothing happens.', '{"damage": 0, "ap_cost_wasted": true}', 1.5, '["Harmless", "Common"]'),
...
VALUES
('WildMagic', 'Moderate', NULL, 'Your Galdr spirals out of control! The {Rune} manifests—but not as you intended! Aether erupts wildly!', '{"random_effect": true, "unpredictable": true}', 1.0, '["Chaotic"]'),
...
('WildMagic', 'Severe', 'Jera', 'Time distortion goes haywire! Everything speeds up, slows down, reverses—temporal chaos!', '{"random_time_effects": true, "affects": "All", "duration": 3}', 0.7, '["Reality-Warping", "Severe"]');
...
('AlfheimDistortion', 'Moderate', NULL, 'Alfheim', 'AlfheimCursedChoir', 'Your rune flickers between states—was that {Rune} or is it {Rune} or will it be {Rune}? Reality rebels, but the weaving resolves... somehow.', '{"spell_works": true, "status": "Disoriented", "duration": 2, "corruption": 2}', 1.0, '["Paradoxical", "Biome"]'),
('AlfheimDistortion', 'Moderate', NULL, 'Alfheim', 'AlfheimCursedChoir', 'The Choir sings your Galdr backwards! Time inverts—the weaving happened before you cast it!', '{"temporal_paradox": true, "random_outcome": true}', 1.0, '["Mind-Breaking", "Biome"]'),
...
('AlfheimDistortion', 'Catastrophic', NULL, 'Alfheim', 'AlfheimCursedChoir', 'The Cursed Choir BECOMES your Galdr! They sing through you—your voice merges with theirs! The effect is perfect and terrifying!', '{"amplified": true, "damage": 20, "corruption": 5, "permanent_effect": "Choir_Touched"}', 0.3, '["Horrifying", "Corrupting", "Powerful"]');
...
VALUES
-- The Roots
('BlightCorruption', 'Moderate', 'The_Roots', 'RunicBlight', 'Rust-tainted Blight seeps into your Galdr! The rune corrodes, Aether decaying mid-cast!', '{"damage": 5, "status": "Corroded", "duration": 2}', 0.8, '["Biome", "Rust"]'),

-- Muspelheim
('WildMagic', 'Moderate', 'Muspelheim', 'AethericOverload', 'The ambient inferno overwhelms your Galdr! Fire weaving spirals out of control!', '{"damage": 8, "fire_explosion": true, "target": "Area"}', 0.8, '["Biome", "Fire"]'),
...
-- Jotunheim
('Paradox', 'Moderate', 'Jotunheim', NULL, 'Ancient giant-song interferes! Your rune clashes with primordial power—reality groans!', '{"damage": 7, "random_effect": true}', 0.8, '["Biome", "Ancient"]');
...
('WildMagic', 'Minor', 'Berkanan', 'Healing Galdr misfires! Flowers sprout from your wounds instead of closing them. They''re pretty, at least.', '{"cosmetic": true, "flowers": true}', 1.0, '["Harmless", "Weird"]'),
