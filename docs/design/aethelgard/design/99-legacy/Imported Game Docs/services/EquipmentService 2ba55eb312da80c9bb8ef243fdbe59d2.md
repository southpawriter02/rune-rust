...
> File: RuneAndRust.Engine/EquipmentService.csVersion: v0.3+
...
- [CombatEngine](https://www.notion.so/combat-engine.md) - Uses equipment stats for combat
- [LootService](https://www.notion.so/loot-service.md) - Generates equipment drops
- [CraftingService](https://www.notion.so/crafting-service.md) - Equipment crafting
- [MerchantService](https://www.notion.so/merchant-service.md) - Equipment trading