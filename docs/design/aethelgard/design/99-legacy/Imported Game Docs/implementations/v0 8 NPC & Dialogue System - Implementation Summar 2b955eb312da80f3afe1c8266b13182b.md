...
- [x]  **Sigrun the Scavenger** (Room 2) - Tutorial NPC, Midgard Combine
...
- [x]  **Kjartan the Rust-Smith** (Room 5) - Future Merchant, Midgard Combine
    - Base Disposition: +30 (Friendly)
    - Lore-keeper, hints at v0.9 merchant system
    - Corruption warning dialogue
- [x]  **Bjorn the Exile** (Room 8) - Hostile Negotiation, Rust-Clans
...
- [x]  **Rolf the Hermit** (Room 18) - Information Broker, Independents
    - Base Disposition: 0 (Neutral)
    - WITS 5 check reveals shortcut to Room 24
    - Bribe option (50 gold - placeholder for v0.9)
- [x]  **Eydis the Survivor** (Room 22) - Trauma Victim, Independents
...
The world is no longer just a series of combat encounters—it's **inhabited**.
