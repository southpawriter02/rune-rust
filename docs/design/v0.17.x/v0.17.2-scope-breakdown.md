...
**Unit Tests (~2):**
- [x] GetRecommendedBuild returns correct values for each archetype
- [x] GetStartingPoints returns 14 for Adept, 15 for others
...
**Unit Tests (~3):**
- [x] TryModifyAttribute succeeds with enough points
- [x] TryModifyAttribute fails when insufficient points
- [x] SwitchMode resets to recommended build in Simple mode
...
**Unit Tests (~3):**
- [x] CalculateDerivedStats produces correct HP
- [x] Lineage modifiers affect calculation
- [x] Preview updates in real-time during allocation
