...
**Unit Tests (~3):**
- [ ] ApplyLineageToCharacter applies all modifiers correctly
- [ ] Clan-Born flexible bonus applies to selected attribute
- [ ] Lineage trait is registered with trait system
...
- [ ] Lineage enum has 4 values
- [ ] Each lineage has unique attribute modifiers
- [ ] Clan-Born allows +1 to any attribute (player choice)
- [ ] Rune-Marked grants +2 WILL, -1 STURDINESS
- [ ] Iron-Blooded grants +2 STURDINESS, -1 WILL
- [ ] Vargr-Kin grants +1 MIGHT, +1 FINESSE, -1 WILL
- [ ] Each lineage has passive bonuses (HP, AP, Soak, Movement, Skill)
- [ ] Each lineage has a unique trait
- [ ] Survivor's Resolve adds dice to Rhetoric with Clan-Born NPCs
- [ ] Aether-Tainted increases Max AP by 10%
- [ ] Hazard Acclimation adds dice vs environmental hazards
- [ ] Primal Clarity reduces Psychic Stress by 10%
- [ ] Rune-Marked starts with 5 permanent Corruption
- [ ] Rune-Marked has -1 to Corruption resistance
- [ ] Iron-Blooded has -1 to Stress resistance
