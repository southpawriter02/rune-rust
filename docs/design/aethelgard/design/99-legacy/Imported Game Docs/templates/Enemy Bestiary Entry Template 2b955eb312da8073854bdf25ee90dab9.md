...
**Enemy ID:** `[enemy_id]`**Type:** [Draugr-Pattern / Symbiotic Plate / Jötun-Reader / Haugbui-Class / Forlorn]
...
**File:** `RuneAndRust.Core/Enemy.cs`**Enum Value:** `EnemyType.[EnumName]`**Factory:** `RuneAndRust.Engine/EnemyFactory.cs`**Method:** `Create[EnemyName]()`
