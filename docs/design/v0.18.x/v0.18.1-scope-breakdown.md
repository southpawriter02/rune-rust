...
- [ ] CorruptionThreshold enum has 6 values with correct ranges
- [ ] CorruptionSource enum has 8 categories
- [ ] All enum values have XML documentation
- [ ] ~2 unit tests pass
...
- [ ] CorruptionState threshold computed correctly from value
...
- [ ] Threshold 25/50/75 crossings trigger exactly once
- [ ] Faction reputation locked at 50+ corruption
- [ ] Terminal Error triggers at exactly 100
- [ ] ~5 unit tests pass
...
- [ ] ICorruptionService defines all 9 methods
