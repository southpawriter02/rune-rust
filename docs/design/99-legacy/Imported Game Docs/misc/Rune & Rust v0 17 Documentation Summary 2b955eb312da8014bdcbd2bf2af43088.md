...
1. **Exploit Design Flaw: 35 → 28 Stamina** (-20%)
2. **Analyze Weakness: 30 → 25 Stamina** (-17%)
3. **Anatomical Insight: 25 → 20 Stamina** (-20%)
4. **Cognitive Realignment: 30 → 25 Stamina** (-17%)
5. **Rally Cry: Enhanced** (1d8 → 2d6 heal, 15ft → 20ft range)
6. **Whirlwind Strike: Clarified** (damage description updated)
...
1. **Clan-Forged Greatsword: +6 → +5 damage** (prevent early-game dominance)
2. **Clan-Forged Full Plate: Added -1 FINESSE penalty** (meaningful trade-off)
3. **Sharpened Scrap: -2 → -1 damage** (better starter experience)
4. **Crude Staff: -2 → -1 damage** (better starter experience)
