...
('Creature', 'ArcWelderUnit', 'Expert', NULL, 'Alive', 'Heavy Construction Frame. The lightning-claw arm can melt plate armor in seconds. Its heart-casket is exposed on the back—a potential weak point if you can flank it.', 1.0, '["Technical", "Machine", "Tactical"]'),
