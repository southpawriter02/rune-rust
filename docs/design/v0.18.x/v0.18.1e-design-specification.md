...
- [ ] `src/Core/RuneAndRust.Application/DTOs/CorruptionSourceDefinitionDto.cs`
- [ ] `src/Core/RuneAndRust.Application/DTOs/ThresholdEffectDto.cs`
- [ ] `src/Core/RuneAndRust.Application/DTOs/CorruptionHistoryEntryDto.cs`
- [ ] `src/Core/RuneAndRust.Application/DTOs/CorruptionConfigurationDto.cs`
...
- [ ] `src/Infrastructure/RuneAndRust.Persistence/Migrations/xxxx_AddCorruptionTables.cs`

### Infrastructure Layer — Repository

- [ ] `src/Infrastructure/RuneAndRust.Persistence/Repositories/CorruptionRepository.cs`

### Domain Layer — History Entry

- [ ] `src/Core/RuneAndRust.Domain/Entities/CorruptionHistoryEntry.cs`

### Unit Tests

- [ ] `tests/RuneAndRust.Infrastructure.UnitTests/Schemas/CorruptionSourcesSchemaTests.cs`

### Documentation

- [ ] Update scope breakdown to mark v0.18.1e complete
- [ ] Update v0.18.x-overview.md if needed
...
- [ ] Schema validates production config
- [ ] Schema rejects corruption values > 100
- [ ] Schema rejects non-kebab-case IDs
- [ ] Schema requires all threshold levels (25/50/75/100)
- [ ] Schema validates penalty formula structure

### Configuration Criteria

- [ ] All corruption source categories are defined
- [ ] Each source has valid ID and name
- [ ] Threshold effects have required properties
- [ ] Penalty formulas use valid expressions

### Database Criteria

- [ ] `character_corruption` table created with proper constraints
- [ ] `corruption_history` table created with proper constraints
- [ ] Foreign keys reference `characters(id)` correctly
- [ ] Indexes created for efficient querying
- [ ] Check constraint validates corruption 0-100

### Repository Criteria

- [ ] `GetByCharacterId` returns tracker or null
- [ ] `Add` persists new tracker
- [ ] `Update` persists tracker changes
- [ ] `AddHistoryEntry` creates audit record
- [ ] `GetHistory` returns entries in descending order
