...
4. **Implement Barrier properly** - HP, LoS blocking, destruction effects
5. **Implement Zones properly** - area effects, duration, stacking rules
6. **Implement Reaction trigger** - Indomitable Bastion interrupt

### Phase 3: Passive Enhancements
7. **Implement Aegis reflection** - damage return on barrier attack
8. **Implement zone cleansing** - debuff removal per turn
9. **Add rank indicators** (Bronze/Silver/Gold)

### Phase 4: GUI
10. **Add barrier HP display** with visual feedback
11. **Add zone indicators** on battlefield
12. **Add capstone availability tracker**
