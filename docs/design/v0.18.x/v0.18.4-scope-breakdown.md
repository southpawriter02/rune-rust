...
- [ ] RageThreshold enum has 5 values with correct ranges
- [ ] RageSource enum has 5 generation categories
- [ ] RageState damage bonus = floor(Rage/10)
- [ ] Damage reduction = floor(Rage/20) × 5%
- [ ] FrenzyBeyondReason grants fear immunity
- [ ] FrenzyBeyondReason forces attack on nearest target
- [ ] Decay rate is 10 per non-combat turn
- [ ] ~5 unit tests pass
...
- [ ] MomentumThreshold enum has 5 values with correct ranges
- [ ] Bonus attacks scale correctly with threshold (0/0/1/1/2)
- [ ] Movement bonus = floor(Momentum/20)
- [ ] Missed attack causes 25 momentum decay
- [ ] Stunned causes full momentum reset
- [ ] ConsecutiveHits tracking enables chain bonuses
- [ ] ~5 unit tests pass
