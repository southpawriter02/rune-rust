...
### 📖 [Abilities Registry](./abilities-registry.md)
...
### ⚔️ [Equipment Registry](./equipment-registry.md)
...
### 👾 [Enemy Registry](./enemy-registry.md)
...
### 🎯 [Status Effects Registry](./status-effects-registry.md)
...
### 📐 [Formulas Registry](./formulas-registry.md)
...
### 💰 [Resource Costs Registry](./resource-costs-registry.md)
...
### 🏆 [Loot Tables Registry](./loot-tables-registry.md)
...
- **Abilities:** [Ability Registry Entry Template](../templates/ability-registry-entry.md)
- **Equipment:** [Equipment Registry Entry Template](../templates/equipment-registry-entry.md)
- **Enemies:** [Enemy Bestiary Entry Template](../templates/enemy-bestiary-entry.md)
