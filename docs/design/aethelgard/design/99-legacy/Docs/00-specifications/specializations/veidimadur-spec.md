...
4. **Implement charged attacks** - Heartseeker Shot charge mechanic
5. **Implement [Blighted Toxin]** DoT effect
6. **Implement [Glitch]** skip action effect

### Phase 3: Capstone
7. **Implement Blight-Stalker's Stance** toggle
8. **Implement vulnerability detection**
9. **Implement corruption purge** damage bonus
