...
- [ ] `src/Core/RuneAndRust.Application/Interfaces/IStressService.cs`

### Documentation

- [ ] XML documentation on interface
- [ ] XML documentation on all 9 methods
- [ ] Parameter and return documentation complete
- [ ] Exception documentation where applicable
- [ ] Code examples in interface remarks
...
- [ ] `IStressService` interface compiles without errors
- [ ] Interface defines exactly 9 methods (4 query, 4 command, 1 internal)
- [ ] All methods have complete XML documentation
- [ ] All parameters have XML parameter documentation
- [ ] All return types have XML returns documentation
- [ ] Interface uses only types from v0.18.0a and v0.18.0b
- [ ] No implementation logic in interface file

### Quality Criteria

- [ ] Build succeeds with 0 errors
- [ ] Build succeeds with 0 warnings
- [ ] Interface follows project naming conventions
- [ ] File-scoped namespace used
- [ ] Methods organized into logical regions (Query, Command, Internal)
