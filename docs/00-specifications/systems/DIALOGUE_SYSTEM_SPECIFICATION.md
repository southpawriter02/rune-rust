...
- [x] Nodes indexed by DialogueNode.Id in dictionary
...
|--------------|--------|--------|------------|-----------|
| NPC.RootDialogueId | NPC JSON | string | Must match DialogueNode.Id | Yes (for conversation) |
| DialogueNode.Id | Dialogue JSON | string | Unique identifier | Yes |
...
**Input Validation**:
- DialogueNode.Id must be unique across all dialogue files
