...
3. [Command Lexicon](#3-command-lexicon)
4. [Interaction Types & Mechanics](#4-interaction-types--mechanics)
5. [Skill Check System](#5-skill-check-system)
6. [Action Economy](#6-action-economy)
7. [Fumble & Consequence System](#7-fumble--consequence-system)
8. [GUI Integration](#8-gui-integration)
9. [Smart Commands Panel](#9-smart-commands-panel)
10. [Feedback & Combat Log](#10-feedback--combat-log)
...
*Related: GUI_SPECIFICATION.md (v0.45), QUEST_JOURNAL_SPECIFICATION.md (v1.0)*
*Extends: InteractiveObject system (v0.38.3)*
