...
**SQL Migration File:**`Data/v0.35.1_territory_control.sql`
...
**C# Repository Updates:**`RuneAndRust.Persistence/SaveRepository.cs`
...
*Document Status: Implementation CompleteNext Steps: Proceed to v0.35.2 (Territory Mechanics & Faction Wars)*