...
### [Damage Output Analysis](https://www.notion.so/damage-output-analysis.md)
...
### [Time-to-Kill (TTK) Analysis](https://www.notion.so/ttk-analysis.md)
...
### [Critical Hit Analysis](https://www.notion.so/critical-hit-analysis.md)
...
### [HP Pool Analysis](https://www.notion.so/hp-pool-analysis.md)
...
### [Damage Mitigation Analysis](https://www.notion.so/damage-mitigation-analysis.md)
...
### [Deaths-per-Encounter Analysis](https://www.notion.so/deaths-per-encounter-analysis.md)
...
### [Stamina Economy](https://www.notion.so/stamina-economy.md)
...
### [Stress Economy](https://www.notion.so/stress-economy.md)
...
### [Corruption Economy](https://www.notion.so/corruption-economy.md)
...
### [Resource Bottleneck Analysis](https://www.notion.so/resource-bottleneck-analysis.md)
...
### [Specialization Effectiveness Matrix](https://www.notion.so/specialization-effectiveness.md)
...
### [Build Diversity Analysis](https://www.notion.so/build-diversity-analysis.md)
...
### [Synergy Analysis](https://www.notion.so/synergy-analysis.md)
...
### [Enemy Scaling Analysis](https://www.notion.so/enemy-scaling-analysis.md)
...
### [Room Difficulty Progression](https://www.notion.so/room-difficulty-progression.md)
...
### [Boss Encounter Analysis](https://www.notion.so/boss-encounter-analysis.md)
...
### [Overtuned Content](https://www.notion.so/overtuned-content.md)
...
### [Undertuned Content](https://www.notion.so/undertuned-content.md)
...
### [Balance Priorities](https://www.notion.so/balance-priorities.md)
...
1. Start with [Specialization Effectiveness Matrix](https://www.notion.so/specialization-effectiveness.md)
2. Identify underperforming specs
3. Drill into [Damage Analysis](https://www.notion.so/damage-output-analysis.md) or [Survivability Analysis](https://www.notion.so/hp-pool-analysis.md)
4. Check [Resource Economy](https://www.notion.so/stamina-economy.md) for bottlenecks
5. Review [Tuning Recommendations](https://www.notion.so/balance-priorities.md)

### For Developers

1. After implementing balance changes, update relevant analysis docs
2. Re-run simulations to verify changes
3. Update [Statistical Registry](https://www.notion.so/02-statistical-registry/) with new values
4. Update [System Documentation](https://www.notion.so/01-systems/) with design rationale
