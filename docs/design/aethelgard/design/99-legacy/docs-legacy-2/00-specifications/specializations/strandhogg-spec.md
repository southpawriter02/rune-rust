...
4. **Implement move + attack** combinations
5. **Implement debuff detection** for bonus damage
6. **Implement kill tracking** for refunds

### Phase 3: Capstone
7. **Implement multi-attack** (Riptide of Carnage)
8. **Add Psychic Stress costs**
9. **Add Momentum bar UI**
