...
See [Data Access Patterns](data-access-patterns.md) for full documentation.
...
- [Service Architecture](service-architecture.md) - Service organization
- [Data Flow](data-flow.md) - How data moves through patterns
- [System Integration Map](system-integration-map.md) - Pattern interactions
