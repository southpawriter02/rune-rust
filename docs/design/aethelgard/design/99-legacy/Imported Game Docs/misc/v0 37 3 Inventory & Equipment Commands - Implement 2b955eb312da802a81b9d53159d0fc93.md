...
1. **RuneAndRust.Tests/InventoryCommandsTests.cs** (~400 lines)
...
1. **Data/v0.37.3_inventory_schema.sql** (~75 lines)
...
**Syntax:** `inventory`, `inv`, `i`**Arguments:** None
...
**Syntax:** `equipment`, `eq`**Arguments:** None
...
**Syntax:** `take [item]`, `get [item]`, `pickup [item]`**Arguments:** Item name (multi-word supported)
...
**Syntax:** `drop [item]`**Arguments:** Item name (multi-word supported)
...
**Syntax:** `use [item]`, `use [item] on [target]`**Arguments:** Item name (and optional target for environmental interaction)
