...
v0.3.16 "The Sentinel" focuses on application stability and crash recovery. This milestone implements global exception handling infrastructure that catches unhandled exceptions, generates detailed crash reports, and presents a user-friendly error screen before graceful shutdown.
