...
1. [Dependency Injection Setup](#dependency-injection-setup)
2. [Service Configuration](#service-configuration)
3. [Database Initialization](#database-initialization)
4. [Difficulty Configuration](#difficulty-configuration)
5. [Boss Configuration](#boss-configuration)
6. [Archetype Tuning](#archetype-tuning)
