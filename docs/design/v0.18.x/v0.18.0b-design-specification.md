...
- [ ] `src/Core/RuneAndRust.Domain/ValueObjects/StressCheckResult.cs`
- [ ] `src/Core/RuneAndRust.Domain/ValueObjects/StressApplicationResult.cs`
- [ ] `src/Core/RuneAndRust.Domain/ValueObjects/StressRecoveryResult.cs`

### Unit Tests

- [ ] `tests/RuneAndRust.Domain.UnitTests/ValueObjects/StressCheckResultTests.cs`
- [ ] `tests/RuneAndRust.Domain.UnitTests/ValueObjects/StressApplicationResultTests.cs`
- [ ] `tests/RuneAndRust.Domain.UnitTests/ValueObjects/StressRecoveryResultTests.cs`

### Documentation

- [ ] XML documentation on all public members
- [ ] Code examples in remarks sections
- [ ] Update scope breakdown to mark v0.18.0b complete
...
- [ ] `StressCheckResult.ReductionPercent` returns 0.00m for 0 successes
- [ ] `StressCheckResult.ReductionPercent` returns 0.50m for 1 success
- [ ] `StressCheckResult.ReductionPercent` returns 0.75m for 2-3 successes
- [ ] `StressCheckResult.ReductionPercent` returns 1.00m for 4+ successes
- [ ] `StressCheckResult.FinalStress` correctly applies reduction to base stress
- [ ] `StressApplicationResult.ThresholdCrossed` is true when NewThreshold > PreviousThreshold
- [ ] `StressApplicationResult.TraumaCheckTriggered` is true when NewStress >= 100
- [ ] `StressRecoveryResult.ThresholdDropped` is true when NewThreshold < PreviousThreshold
- [ ] `StressRecoveryResult.AmountRecovered` equals PreviousStress - NewStress
