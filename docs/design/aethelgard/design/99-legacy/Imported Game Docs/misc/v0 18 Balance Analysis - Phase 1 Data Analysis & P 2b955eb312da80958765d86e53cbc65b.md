...
- Current curve is tuned for SHORT runs (15-20 minutes, documented in [Legend-Leveling.md](http://legend-leveling.md/))
...
1. **🟡 Exploit Design Flaw Too Expensive (35 Stamina)**
...
2. **🟡 Analyze Weakness Too Expensive (30 Stamina + 5 Stress)**
...
3. **🟡 Servitor Swarm Undervalued (30 Legend for 50 HP)**
...
4. **🟡 Failure Colossus One-Shot Risk (4d6+3 = 17 avg damage)**
...
5. **🟡 Sentinel Prime Excessive Damage (5d6 = 17.5 avg)**
...
6. **🟡 Anatomical Insight Expensive (25 Stamina)**
...
7. **🟡 Cognitive Realignment Expensive (30 Stamina)**
