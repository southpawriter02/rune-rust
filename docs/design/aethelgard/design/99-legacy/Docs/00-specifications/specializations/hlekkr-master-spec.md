...
4. **Implement Pull/Push mechanics** - position displacement
5. **Implement corruption scaling** - success chance modifier
6. **Implement damage bonuses** vs controlled enemies

### Phase 3: Capstone
7. **Implement [Vulnerable] on displacement**
8. **Implement Corruption Bomb** - AoE Psychic burst
9. **Add chain DoT** vs controlled enemies
