...
**File Path:** `RuneAndRust.Engine/DiceService.cs`
**Version:** v0.21.3
...
- [Combat Resolution](../../01-systems/combat-resolution.md) - Dice usage in combat
- [Damage Calculation](../../01-systems/damage-calculation.md) - Damage roll mechanics

### Related Services

- [CombatEngine](./combat-engine.md) - Primary consumer of dice rolls
- [EnemyAI](./enemy-ai.md) - Uses dice for random decisions
