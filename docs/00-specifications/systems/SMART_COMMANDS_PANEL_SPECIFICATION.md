...
3. [Panel Layout & Structure](#3-panel-layout--structure)
4. [Command Generation Logic](#4-command-generation-logic)
5. [Hotkey System](#5-hotkey-system)
6. [Context Awareness](#6-context-awareness)
7. [Visual Design](#7-visual-design)
8. [ViewModels & Data Binding](#8-viewmodels--data-binding)
