...
- [x] `src/Core/RuneAndRust.Domain/Enums/StressThreshold.cs`
- [x] `src/Core/RuneAndRust.Domain/Extensions/StressThresholdExtensions.cs`
- [x] `src/Core/RuneAndRust.Domain/Enums/StressSource.cs`
- [x] `src/Core/RuneAndRust.Domain/Extensions/StressSourceExtensions.cs`
- [x] `src/Core/RuneAndRust.Domain/Enums/RestType.cs`
- [x] `src/Core/RuneAndRust.Domain/Extensions/RestTypeExtensions.cs`

### Domain Layer — Value Objects

- [x] `src/Core/RuneAndRust.Domain/ValueObjects/StressState.cs`

### Unit Tests

- [x] `tests/RuneAndRust.Domain.UnitTests/Enums/StressThresholdTests.cs`
- [x] `tests/RuneAndRust.Domain.UnitTests/ValueObjects/StressStateTests.cs`
- [x] `tests/RuneAndRust.Domain.UnitTests/Extensions/RestTypeExtensionsTests.cs`
- [x] `tests/RuneAndRust.Domain.UnitTests/Extensions/StressSourceExtensionsTests.cs`

### Documentation

- [x] XML documentation on all public members
- [x] Code examples in remarks where applicable
- [x] Update scope breakdown to mark v0.18.0a complete
...
- [x] `StressThreshold` enum has exactly 6 values (Calm through Trauma)
- [x] `StressThresholdExtensions.FromStressValue()` correctly maps all stress values 0-100
- [x] `StressSource` enum has exactly 6 categories
- [x] `RestType` enum has exactly 4 types
- [x] `RestTypeExtensions.CalculateRecovery()` returns correct values for all rest types
- [x] `StressState.Create()` clamps stress values to 0-100 range
- [x] `StressState.DefensePenalty` equals `floor(CurrentStress / 20)`
- [x] `StressState.HasSkillDisadvantage` is true when stress >= 80
- [x] `StressState.RequiresTraumaCheck` is true when stress >= 100
- [x] `StressState.WithStress()` returns new instance without mutating original

### Quality Criteria

- [x] Build succeeds with 0 errors
- [x] Build succeeds with 0 warnings
- [x] All ~4 unit tests pass (actual: 66 tests across 4 test files)
- [x] XML documentation complete on all public types and members
- [x] All enum values have XML summary documentation
- [x] Code follows project conventions (file-scoped namespaces, primary constructors where appropriate)

### Code Style Criteria

- [x] 4-space indentation in C# files
- [x] File-scoped namespaces used
- [x] Null-forgiving assignments in private constructors where needed
- [x] ArgumentException helpers used for validation
