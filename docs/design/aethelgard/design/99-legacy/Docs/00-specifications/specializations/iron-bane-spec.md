...
5. **Route Iron-Bane abilities** through CombatEngine
6. **Implement type-based damage bonuses** for Mechanical/Undying
7. **Add Fervor bar** to CombatView
8. **Implement target restrictions** for abilities

### Phase 3: Status Effects
9. **Define status effects** ([Burning], [System Malfunction], [Critical Failure])
10. **Implement uncleansable Burning** for Mechanical/Undying
11. **Implement instant death mechanics** (Divine Purge)

### Phase 4: Advanced Features
12. **Implement execute threshold** (Critical Strike Rank 3)
13. **Implement AoE explosion on kill** (Divine Purge Rank 2)
14. **Implement kill refund system** (Righteous Conviction)

### Phase 5: Polish
15. **Add rank-specific icons** (Bronze/Silver/Gold)
16. **Implement enemy analysis panel**
17. **Add Divine Purge activation notification**
