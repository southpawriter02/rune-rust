...
**File Path:** `RuneAndRust.Engine/BiomeLibrary.cs`**Version:** v0.10
...
- [Procedural Generation](https://www.notion.so/PROCEDURAL_GENERATION.md) - Generation overview
- [DungeonGenerator](https://www.notion.so/dungeon-generator.md) - Uses biome definitions

### Related Services

- [DungeonGenerator](https://www.notion.so/dungeon-generator.md) - Consumes biome parameters
- [PopulationPipeline](https://www.notion.so/population-pipeline.md) - Uses element tables
- [TemplateLibrary](https://www.notion.so/template-library.md) - Room templates
