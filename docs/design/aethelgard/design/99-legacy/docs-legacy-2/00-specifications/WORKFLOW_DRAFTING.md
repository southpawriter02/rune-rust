...
2. [Drafting Workflow Overview](#drafting-workflow-overview)
3. [Step 1: Setup & Initialization](#step-1-setup--initialization)
4. [Step 2: Document Control & Executive Summary](#step-2-document-control--executive-summary)
5. [Step 3: Related Documentation & Dependencies](#step-3-related-documentation--dependencies)
6. [Step 4: Design Philosophy](#step-4-design-philosophy)
7. [Step 5: Functional Requirements](#step-5-functional-requirements)
8. [Step 6: System Mechanics](#step-6-system-mechanics)
9. [Step 7: Integration Points](#step-7-integration-points)
10. [Step 8: Implementation Guidance](#step-8-implementation-guidance)
11. [Step 9: Balance & Tuning](#step-9-balance--tuning)
12. [Step 10: Validation & Testing](#step-10-validation--testing)
13. [Step 11: Quality Review](#step-11-quality-review)
14. [Step 12: Finalization](#step-12-finalization)
15. [Drafting Checklist](#drafting-checklist)
...
- [ ] SPEC-RULE-001: Uses TEMPLATE.md structure
...
### Setup
- [ ] Spec file created from TEMPLATE.md
